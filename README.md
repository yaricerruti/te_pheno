...
The entire pipeline is organized into the following snakefiles. Scripts called by these snakefiles are available in the src directory. The individual steps are described by comments inside the snakefiles. For convenience the data used for the linear models and the complete linear model results are available in the data directory.
